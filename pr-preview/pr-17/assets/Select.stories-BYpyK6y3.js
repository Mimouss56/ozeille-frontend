import{S as a}from"./Select-D58SJ15u.js";import"./iframe-D4VSmP3U.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DutoEiXV.js";import"./Label-COTtZf2G.js";import"./StatusMessage-4_yZqKsZ.js";const p={title:"UI/Select",component:a,tags:["autodocs"],parameters:{layout:"centered"},args:{disabled:!1,label:"Frequency",placeholder:"Select an option",options:[{label:"Hebdomadaire",value:"weekly"},{label:"Mensuel",value:"monthly"},{label:"Annuel",value:"yearly"}]},argTypes:{size:{control:"radio",options:["xs","sm","md","lg","xl"],description:"Taille de l'input"},style:{control:"select",options:["primary","secondary","neutral","accent","info","success","warning","error"],description:"Couleur/État de l'input"},disabled:{control:"boolean"},helperText:{control:"text"},label:{control:"text"}}},e={},r={args:{id:"storybook-category",label:"Category",helperText:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",options:[{label:"admin",value:"error"}]}},o={args:{id:"storybook-category",label:"Category",style:"error",helperText:"Please select a valid category",options:[{label:"admin",value:"error"}]}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"{}",...e.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
